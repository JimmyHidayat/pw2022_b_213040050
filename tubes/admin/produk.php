		...
		if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){
		  if($ukuran_file <= 50000000){ 
			if(move_uploaded_file($tmp_file, $path)){ 
			  ...
			  $query = "insert into produk (idkategori, namaproduk, gambar, deskripsi, rate, harga)
			  values('$idkategori','$namaproduk','$pathdb','$deskripsi','$rate','$harga')";
		  ...
		  echo "Sorry, the image format should be JPG/PNG/WEBP/JEPG.";
		  echo "<br><meta http-equiv='refresh' content='5; URL=produk.php'> You will be redirected to the form in 5 seconds";
		}
