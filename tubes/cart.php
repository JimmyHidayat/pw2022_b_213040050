			...
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<tr class="rem1"><form method="post">
						...
						<td class="invert">$<?php echo number_format($b['harga']) ?></td>
						<td class="invert">
							<div class="rem">
			...
			<div class="checkout-left">	
				<div class="checkout-left-basket">
					...
					<ul>
						...
						$subtotal += $totalharga
						?>
						<li><?php echo $b['namaproduk']?><i> - </i> <span>$<?php echo number_format($totalharga) ?> </span></li>
						<?php
						}
						?>
						<li>Total (inc. 10$ Fee)<i> - </i> <span>$<?php echo number_format($subtotal) ?></span></li>
					</ul>
				</div>
